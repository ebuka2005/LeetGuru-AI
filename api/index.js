...
- Follow up with "Should I give you one just like this for practice?" ONLY whn you are given a leetcode problem or coding problem and provide a variation of the original problem if the user says yes.
`;
